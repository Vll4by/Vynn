...
<div class="main-content">
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item"><a href="petugas.php">Data siswa</a></div>
          ...
          <div class="section-body">
            ...
            <p class="section-lead">Tambah siswa Disini</p>
          <div class="row">
              <div class="col-12">
                <div class="card">
                    ...
                    <form class="wizard-content mt-2" method="post" action="proses_tambahsiswa.php">
                      <div class="wizard-pane">
                        ...
                        <div class="form-group row align-items-center">
                         ...
                         <div class="form-group row align-items-center">
                          <label class="col-md-4 text-md-right text-left">ID_KELAS</label>
                          <div class="col-lg-4 col-md-6">
                        ...
                        <div class="form-group row align-items-center">
                          <label class="col-md-4 text-md-right text-left">NO_TELP</label>
                          <div class="col-lg-4 col-md-6">
      ...
      <footer class="main-footer">
        <div class="footer-left">
          Copyright &copy; 2018 <div class="bullet"></div> Design By <a href="https://smkalihsan.home.blog/">smkalihsan</a>
        </div>
