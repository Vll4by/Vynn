...
<div class="main-content">
        <section class="section">
          ...
          <div class="section-body">
            <h2 class="section-title">Edit SPP</h2>
            <p class="section-lead">Edit SPP Disini</p>
          <div class="row">
              <div class="col-12">
                <div class="card">
                      ...
                      <div class="wizard-pane">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-lg-4 col-md-6 text-right">
                            <button type="submit" class="btn btn-icon icon-right btn-primary">Rubah SPP<i class="fas fa-arrow-right"></i></button>>
                          </div>
                        </div>
                      </div>
                    </form>
