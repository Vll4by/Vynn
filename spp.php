      ...
      <div class="main-content bg-">
        <section class="section">
          ...
          <div class="section-body">
            ...
            <p class="section-lead">List Data SPP</p>
                      ...
                      <table class="table table-striped">
                       <thead>
                        ...
                        <tr>  
                          ...
                          <a href="proses_hapusspp.php?id=<?php echo $row['id_spp']; ?>" class="btn btn-primary" onClick="return confirm('Anda yakin akan menghapus data ini?')"><i class="fas fa-trash"></i></a>
                          </td>
                        </tr>
                         <?php
